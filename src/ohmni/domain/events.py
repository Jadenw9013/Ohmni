...
class EventKind(StrEnum):
    ...
    PCB_COMPILATION_STARTED = "pcb_compilation_started"
    FOOTPRINT_RESOLVED = "footprint_resolved"
    PAD_BINDING_RESOLVED = "pad_binding_resolved"
    PLACEMENT_CONSTRAINT_APPLIED = "placement_constraint_applied"
    COMPONENT_PLACED = "component_placed"
    PHYSICAL_VALIDATION_RUN = "physical_validation_run"
    PHYSICAL_VALIDATION_FAILED = "physical_validation_failed"
    PCB_ARTIFACT_COMPILED = "pcb_artifact_compiled"
    DRC_STARTED = "drc_started"
    DRC_COMPLETED = "drc_completed"
    DRC_FINDING_RECORDED = "drc_finding_recorded"
    ROUTING_STARTED = "routing_started"
    ROUTING_PROFILE_SELECTED = "routing_profile_selected"
    NET_ROUTING_STARTED = "net_routing_started"
    ROUTE_FOUND = "route_found"
    VIA_INSERTED = "via_inserted"
    ROUTE_SEARCH_FAILED = "route_search_failed"
    REROUTE_ATTEMPTED = "reroute_attempted"
    ROUTING_COMPLETED = "routing_completed"
    ROUTING_VERIFICATION_STARTED = "routing_verification_started"
    ROUTING_VERIFICATION_FAILED = "routing_verification_failed"
    ROUTED_PCB_COMPILED = "routed_pcb_compiled"
    MANUFACTURING_PROFILE_SELECTED = "manufacturing_profile_selected"
    MANUFACTURING_CONSTRAINT_CHECKED = "manufacturing_constraint_checked"
    MANUFACTURING_CONSTRAINT_FAILED = "manufacturing_constraint_failed"
    BOM_GENERATED = "bom_generated"
    SUPPLIER_OFFER_LOADED = "supplier_offer_loaded"
    PRICING_UNKNOWN = "pricing_unknown"
    ASSEMBLY_RISK_IDENTIFIED = "assembly_risk_identified"
    FABRICATION_EXPORT_STARTED = "fabrication_export_started"
    GERBER_GENERATED = "gerber_generated"
    DRILL_FILE_GENERATED = "drill_file_generated"
    FABRICATION_PACKAGE_COMPLETED = "fabrication_package_completed"
